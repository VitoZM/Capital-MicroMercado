...
ALTER PROC INSERTARCOMPRA @COS FLOAT,@DES VARCHAR(200),@DIS VARCHAR(60),@DIR VARCHAR(60),@TEL VARCHAR(20),@CAT VARCHAR(25),@USU INT,@DESCU FLOAT,@COFI FLOAT
AS
	DECLARE @ID INT
	...
	INSERT INTO COMPRA VALUES(GETDATE(),@COS,1,@DES,@ID,@USU,@DESCU,@COFI)
