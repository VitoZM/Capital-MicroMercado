...
--2. BAJA DE VENTAS
SELECT * FROM VENTA
EXEC DARBAJAVENTA 17,'PORQUE ME DA LA GANA' ---CREATE PROC DARBAJAVENTA @IDVEN INT
EXEC DARBAJALOTEVENTA 17,16,1 ---ALTER PROC DARBAJALOTEVENTA @IDVEN INT,@IDPRO INT,@CAN INT
